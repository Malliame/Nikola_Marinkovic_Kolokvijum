package com.example.kolokvijum.view.viewpager;
...
import com.example.kolokvijum.view.fragments.ProfileFragment;
...
public class PagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            ...
            case FRAGMENT_2: fragment = new ErrandFragment();break;
